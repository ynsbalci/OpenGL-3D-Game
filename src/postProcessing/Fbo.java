...
public class Fbo {
	...
	private void determineDrawBuffers() {
		IntBuffer drawBufers = BufferUtils.createIntBuffer(2);
		drawBufers.put(GL30.GL_COLOR_ATTACHMENT0);
		if(multisampleAndMultiTarget) {
			drawBufers.put(GL30.GL_COLOR_ATTACHMENT1);
		}
		drawBufers.flip();
		GL20.glDrawBuffers(drawBufers);
	}
