		...
		try {
			...
			while (true) {
				...
				if (line.startsWith("v ")) {
					...
					texturesArray = new float[normals.size() * 2];
					break;
				} 
			...
			while(line != null) {
				...
				String[] currentLine = line.split(" ");
				String[] vertice1 = currentLine[1].split("/");
				String[] vertice2 = currentLine[2].split("/");
				String[] vertice3 = currentLine[3].split("/");
				
				
				processVertex(vertice1, indices, textures, normals, texturesArray, normalsArray);
				processVertex(vertice2, indices, textures, normals, texturesArray, normalsArray);
				processVertex(vertice3, indices, textures, normals, texturesArray, normalsArray);
				line = reader.readLine();
